...
const features = [
  ...
  },
  {
    ...
    body: "Every COLOR & SCENT design starts as a hand illustration. No AI slop. No stock vectors. No cutting corners. Original art on your back, full stop.",
  },
  {
    icon: Printer,
    title: "DTG Printed",
...
export function WhyColor & Scent() {
  return (
