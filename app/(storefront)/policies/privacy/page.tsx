...
export const metadata: Metadata = { title: "Privacy Policy — COLOR & SCENT" }
    ...
    <div className="py-20 px-4">
      <div className="max-w-2xl mx-auto space-y-8 text-muted-foreground">
        ...
        <section>
          ...
          <p>You can request access to, correction of, or deletion of your personal data at any time by contacting us at <a href="mailto:hello@colorandscent.com" className="text-primary">hello@colorandscent.com</a>.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Contact</h2>
          <p>Questions about this policy? Email us at <a href="mailto:hello@colorandscent.com" className="text-primary">hello@colorandscent.com</a>.</p>
        </section>
      </div>
    </div>
  )
