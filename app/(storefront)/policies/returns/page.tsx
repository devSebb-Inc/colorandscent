...
export const metadata: Metadata = { title: "Returns Policy — COLOR & SCENT" }
        ...
        <div className="space-y-8 text-muted-foreground">
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>Email us at <a href="mailto:hello@colorandscent.com" className="text-primary">hello@colorandscent.com</a> with your order number</li>
