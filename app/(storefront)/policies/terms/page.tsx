...
export const metadata: Metadata = { title: "Terms of Service — COLOR & SCENT" }
    ...
    <div className="py-20 px-4">
      <div className="max-w-2xl mx-auto space-y-8 text-muted-foreground">
        ...
        <section>
          ...
          <p>By using colorandscent.com, you agree to these Terms of Service. If you disagree, please do not use our website.</p>
        </section>
        ...
        <section>
          ...
          <p>All designs, artwork, and content on this site are owned by COLOR & SCENT and may not be reproduced, distributed, or used without written permission.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Limitation of Liability</h2>
          <p>COLOR & SCENT is not liable for indirect, incidental, or consequential damages arising from your use of our products or website.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Contact</h2>
          <p>Questions? Email <a href="mailto:hello@colorandscent.com" className="text-primary">hello@colorandscent.com</a>.</p>
        </section>
      </div>
    </div>
  )
