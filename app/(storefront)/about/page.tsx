...
export const metadata: Metadata = {
  ...
  description: "Learn about COLOR & SCENT — Japanese-inspired apparel where mythology, food culture, and home décor collide.",
}
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-xl">
            Where mythology, ramen obsession, and home décor collide.
          </p>
        </div>

        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
          <p className="text-lg text-foreground">
            COLOR & SCENT () started with a simple obsession: Japanese culture deserved better representation in home décor.
          </p>
