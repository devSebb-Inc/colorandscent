...
export async function sendOrderConfirmationEmail(opts: OrderConfirmationOptions) {
  ...
  const html = `
    ...
    <head>
      <meta charset="utf-8">
      <title>Order Confirmed — COLOR & SCENT</title>
    </head>
    <body style="background: #0f0f0f; color: #f0ebe3; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 0; padding: 40px 20px;">
      <div style="max-width: 560px; margin: 0 auto;">
        <h1 style="font-size: 28px; font-weight: 900; letter-spacing: -0.02em; margin: 0 0 8px;">COLOR & SCENT</h1>
        ...
        <p style="margin-top: 40px; color: #a09a90; font-size: 12px;">
          Questions? Email us at <a href="mailto:hello@colorandscent.com" style="color: #cc4444;">hello@colorandscent.com</a>
          <br>© 2026 COLOR & SCENT. Made with 🍜 in the USA.
        </p>
      </div>
    </body>
    </html>
...
export async function sendShippingNotificationEmail(opts: ShippingNotificationOptions) {
  const html = `
    <!DOCTYPE html>
    <html>
    <head><meta charset="utf-8"><title>Your COLOR & SCENT order shipped!</title></head>
    <body style="background: #0f0f0f; color: #f0ebe3; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 0; padding: 40px 20px;">
      <div style="max-width: 560px; margin: 0 auto;">
        <h1 style="font-size: 28px; font-weight: 900; letter-spacing: -0.02em; margin: 0 0 8px;">COLOR & SCENT</h1>
        <p style="color: #a09a90; margin: 0 0 40px;">Wear the Culture.</p>
        ...
        <p style="margin-top: 40px; color: #a09a90; font-size: 12px;">
          © 2026 COLOR & SCENT. Made with 🍜 in the USA.
        </p>
      </div>
    </body>
    </html>
  ...
  return resend.emails.send({
    from: EMAIL_FROM_ADDRESS,
    to: opts.to,
    subject: `Your COLOR & SCENT order shipped! — ${opts.orderNumber}`,
    html,
  })
}
...
export async function sendWelcomeEmail(opts: WelcomeEmailOptions) {
  const html = `
    <!DOCTYPE html>
    <html>
    <head><meta charset="utf-8"><title>Welcome to COLOR & SCENT!</title></head>
    <body style="background: #0f0f0f; color: #f0ebe3; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 0; padding: 40px 20px;">
      <div style="max-width: 560px; margin: 0 auto; text-align: center;">
        <h1 style="font-size: 40px; font-weight: 900; margin: 0 0 8px;">🍜</h1>
        <h2 style="font-size: 28px; font-weight: 900; letter-spacing: -0.02em; margin: 0 0 8px;">Welcome to COLOR & SCENT</h2>
  ...
  return resend.emails.send({
    from: EMAIL_FROM_ADDRESS,
    to: opts.to,
    subject: "Welcome to COLOR & SCENT — here's your 25% off 🍜",
    html,
  })
}
...
export async function sendAbandonedCartEmail(opts: AbandonedCartEmailOptions) {
  ...
  const html = `
    ...
    <body style="background: #0f0f0f; color: #f0ebe3; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 0; padding: 40px 20px;">
      <div style="max-width: 560px; margin: 0 auto;">
        <h1 style="font-size: 28px; font-weight: 900; margin: 0 0 8px;">COLOR & SCENT</h1>
        <p style="color: #a09a90; margin: 0 0 40px;">Wear the Culture.</p>
        ...
        <p style="margin-top: 40px; color: #a09a90; font-size: 12px;">
          © 2026 COLOR & SCENT. Made with 🍜 in the USA.
          <br>You're receiving this because you started a checkout on colorandscent.com.
        </p>
      </div>
    </body>
    </html>
