-- ============================================================
-- COLOR & SCENT — Seed Products Migration
...
Wear it to your next ramen crawl. Wear it to brunch. Wear it to assert dominance over anyone who thinks guinea pigs can''t be elegant.',
  ...
  'The Ramen Connoisseur T-Shirt | Kawaii Guinea Pig Kimono Tee | COLOR & SCENT',
...
A fan favorite for a reason. If you''ve ever made eye contact with a cat and felt like it was reading your soul, this tee gets it.',
  ...
  'Black Cat Ramen T-Shirt | Japanese Cat Graphic Tee | COLOR & SCENT',
...
Drawn in the style of traditional ukiyo-e woodblock prints, this design channels centuries of artisan fragrance history through a distinctly COLOR & SCENT lens. The intricate armor detailing and dramatic pose would make Miyamoto Musashi himself crack a smile.
...
For those who carry themselves with quiet strength and loud ramen orders. The way of the noodle demands nothing less.',
  ...
  'Warrior''s Feast T-Shirt | Samurai Cat Ramen Tee | COLOR & SCENT',
...
Perfect for anyone who''s ever said "I could eat a whole building" and meant it literally. Go big or go home. Preferably with leftovers.',
  ...
  'City-Sized Hunger T-Shirt | Kaiju Dragon Ramen Tee | COLOR & SCENT',
...
For the contemplative ramen lover. The one who knows that the best meals happen when you stop trying to be somewhere else.',
  ...
  'Black Cat at Golden Hour T-Shirt | Sunset Ramen Cat Tee | COLOR & SCENT',
...
(
  ...
  'Hokusai''s Ramen',
  'THE GREAT SLURP',
  'Katsushika Hokusai''s "The Great Wave off Kanagawa" is arguably the most iconic piece of artisan fragrance ever created. We asked a simple question: what if it was soup?

Koi fish leap through towering waves of broth. Noodles cascade like seafoam. The entire composition reimagines one of art history''s greatest works as the world''s most epic bowl of ramen. It''s absurd. It''s beautiful. It''s everything COLOR & SCENT stands for.
...
This is our collector''s piece — the one that art history nerds and ramen fanatics agree on. Hang-worthy, but we put it on a shirt instead because art belongs on your back, not your wall.',
  ...
  'Hokusai''s Ramen T-Shirt | Great Wave Ramen Tee | COLOR & SCENT',
...
Limited for a reason. Some designs are too special to mass-produce. This is one of them.',
  ...
  'Blossom & Broth T-Shirt | Sakura Dragon Ramen Tee | COLOR & SCENT',
